...
import deepboof.forward.ChecksForwardSpatialMaxPooling_F32;
 ...
 * @author Peter Abeles
 */
public class TestSpatialMaxPooling_F32 extends ChecksForwardSpatialMaxPooling_F32 {
	...
	protected Function<Tensor_F32> createForwards(ConfigSpatial configSpatial,
		...
		return new SpatialMaxPooling_F32(configSpatial,padding);
	}
}

...
public class ConvertFile32From64 {
	...
	public void process() throws IOException {
		...
		// copyright is a special case and don't want it turning Apache 2.0 info 2.0f
		copyTheCopyRight(s);
	...
	private void handleToken( String s ) {
		...
		s = s.replaceAll( "/\\*\\*/getDouble", "__GET_DOUBLE" );
		s = s.replaceAll( "double", "float" );
		s = s.replaceAll( "Double", "Float" );
		s = s.replaceAll( "_F64", "_F32" );
		s = s.replaceAll( "DOUBLE_TEST_TOL", "FLOAT_TEST_TOL" );
		s = s.replaceAll( "TEST_TOL_F64", "TEST_TOL_F32" );
		s = s.replaceAll( "TEST_TOL_A_F64", "TEST_TOL_A_F32" );
		s = s.replaceAll( "TEST_TOL_B_F64", "TEST_TOL_B_F32" );
		...
		s = s.replaceAll( "__GET_DOUBLE","/\\*\\*/getDouble" );

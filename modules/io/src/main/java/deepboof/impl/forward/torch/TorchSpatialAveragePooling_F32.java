 ...
 * @author Peter Abeles
 */
public class TorchSpatialAveragePooling_F32 extends SpatialAveragePooling_F32 {
	public TorchSpatialAveragePooling_F32(ConfigSpatial config, SpatialPadding2D_F32 padding) {
		super(config, padding);
	}

	@Override
	protected void forwardAt_border(SpatialPadding2D_F32 padded,

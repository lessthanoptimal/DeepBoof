...
/**
 * Max spatial pooling down samples the input spatial tensors by finding the element with the maximum value
 * in each pooling region.  The intent is to reduce the number of variables while maintaining much of the original
 ...
 *   <li>Apply spatial max pooling to padded image</li>
 * </ol>
 *
 * <p>Notes</p>
 * <ul>
 ...
 * @author Peter Abeles
 */
public interface SpatialMaxPooling<T extends Tensor> extends Function<T> {

 ...
 * @author Peter Abeles
 */
public abstract class ChecksForwardActivationReLU_F64 extends ChecksForwardElementWise_F64 {

	public ChecksForwardActivationReLU_F64() {
		inputScale = 2.0;
	}
	...
	public void checkForwardResults(Tensor_F64 input, Tensor_F64 output) {
		...
		for (int i = 0; i < N; i++) {
			...
			if( value < 0 )
				Assert.assertEquals(0,output.getAtIndex(i), DeepBoofConstants.TEST_TOL_F64);
			else
				assertEquals(value,output.getAtIndex(i), DeepBoofConstants.TEST_TOL_F64);
		}
	}
}